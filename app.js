...
app.get('/auth/change', UserController.authMiddleware, UserController.changePage);
app.post('/user/change', UserController.authMiddleware, UserController.changeProfile)
